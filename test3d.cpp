...
TEST(Matrix3dTest, Dot3dx4d) {
    Matrix3d<3> A({ 0.4049,  1.2885,  0.1646,  0.5324, -0.1365,  1.1170,  1.6606, -1.1688,
         -0.9491, -0.6799, -2.0757, -0.6711,  0.3976,  0.8726,  0.4130, -1.5432}, {2, 2, 4});
    Matrix3d<4> B({-0.1198,  0.0217, -0.1250,  2.5582,  1.2036, -0.3478,  0.2945, -0.3526,
          0.9556,  0.1336, -0.7317, -1.4147,  0.1891, -0.1871,  0.4977,  1.5833}, {2, 1, 4, 2});
    Matrix3d<4> C({ 0.1453,  3.0602,  1.5311,  2.6892, -2.4973, -0.8013, -0.1142,  2.6416,
        -0.2598, -0.9566, -1.2155, -3.7598, -1.1360,  0.1610, -0.9486, -3.7020}, {2, 2, 2, 2});
    Matrix3d<4> D = A.dot(B);
    D.printMatrix();
    ASSERT_TRUE(D == C);
}
